/**
 * MediaExplorerSheet Component (Web Version)
 * 
 * A Google Photos-style bottom sheet that shows:
 * - Map placeholder (maps not supported on web)
...
// Sheet snap points
const SHEET_COLLAPSED = SCREEN_HEIGHT * 0.6;
const SHEET_EXPANDED = SCREEN_HEIGHT * 0.1;
 ...
 * Web map placeholder
 */
const WebMapPlaceholder = memo(({ selectedLocation, style }) => (
